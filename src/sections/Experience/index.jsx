            ...
            >
                ...
                <div className="grid gap-y-4">
                    ...
                    <div className="flex gap-4 text-xl">
                        <a href="https://supphawichh.github.io/vitereact/" target="_blank" className="hover:scale-110"><FontAwesomeIcon icon={faGithub} /></a>
                        <a href="https://supphawichh.github.io/vitereact/" target="_blank" className="hover:scale-110"><FontAwesomeIcon icon={faMedium} /></a>
                        <a href="https://supphawichh.github.io/vitereact/" target="_blank" className="hover:scale-110"><FontAwesomeIcon icon={faYoutube} /></a>
                    </div>
